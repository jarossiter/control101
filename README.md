...
3) Simulink files supporting an introduction to modelling, simulation and control, with a focus on basic simulink elelemnts, non-linearity and passing data to and from the MATLAB command window workspace. Simulink is more sensitive to the MATLAB version so the app file will only work with version 2023b or more recent.
