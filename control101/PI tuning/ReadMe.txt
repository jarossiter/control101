...
This resource provides an interactive app file (MATLAB virtual laboratory) which allows users to explore and analyse the tuning of a PI compensator for a range of simple low order models. More detailed descriptions and help are in the partner livescript file pi_tuning_manual.mlx.
