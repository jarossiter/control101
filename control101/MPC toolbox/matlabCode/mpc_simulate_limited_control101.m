...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
H=round(H,8,'significant');  % Assume limited accuracy
P=round(P,8,'significant');
Q=round(Q,8,'significant');
...
Nk=round(Nk,4,'significant');
Dk=round(Dk,4,'significant');
Pr=round(Pr,4,'significant');
