...
%%%%%%%%%%%%%%  (2) Simulates MIMO GPC with constraint handling - no
%%%%%%%%%%%%%%  advance knowledge of target assumed
%%%
%%%%%  [Nk,Dk,Pr] = mpc_simulate(B,A,nu,ny,Wu,Wy)
%%%%%         Du(k) = Pr*r(k+1) - Dk*Du(k-1) - Nk*y(k) 
%%
%%%%%  [y,u,Du,r] = mpc_simulate_inputconstraints_control101(B,A,nu,ny,Wu,Wy,Dumax,umax,umin,ref,dist,noise)
...
%
% [y,u,Du,r,d] = mpc_simulate_inputconstraints_control101(B,A,nu,ny,Wu,Wy,Dumax,umax,umin,ref,dist,noise)
%%  
%% Author: J.A. Rossiter  (email: J.A.Rossiter@shef.ac.uk)

function [y,u,Du,r] = mpc_simulate_inputconstraints_control101(B,A,nu,ny,Wu,Wy,Dumax,umax,umin,ref,dist,noise)
...
%%%%%%   CC*Dufut - dd - du*ut <= 0
[CC,dd,du]  = mpc_constraints_control101(Dumax,umax,umin,sizey,nu);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
