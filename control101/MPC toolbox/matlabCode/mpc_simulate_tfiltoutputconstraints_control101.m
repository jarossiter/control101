...
%%%
%%%%%  [y,u,Du,r] = mpc_simulate_tfilt_outputconstraints_control101(B,A,Tfilt,nu,ny,Wu,Wy,Dumax,umax,umin,ymax,ymin,ref,dist,noise)
...
%
%%%%%
%%%%%  [y,u,Du,r] = mpc_simulate_tfiltoutputconstraints_control101(B,A,Tfilt,nu,ny,Wu,Wy,Dumax,umax,umin,ymax,ymin,ref,dist,noise)
%%  
%% Author: J.A. Rossiter  (email: J.A.Rossiter@shef.ac.uk)

function [y,u,Du,r] = mpc_simulate_tfiltoutputconstraints_control101(B,A,Tfilt,nu,ny,Wu,Wy,Dumax,umax,umin,ymax,ymin,ref,dist,noise)
...
[CC,dd,du,ddu,dy]  = mpc_constraints2_control101(Dumax,umax,umin,ymax,ymin,sizey,nu,H(:,1:nu*sizey),Pt,Qt);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(222);
aa=plot(time,Du','-',time2,Dulim,'--',time2,-Dulim,'--');
set(aa,'linewidth',2)
