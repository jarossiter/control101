...
This resource provides an introduction to the use of simulink for modelling and simulation system behaviour. 
The main resource is a virtual laboratory or Matlab app which steps users through the basic elements of a simulink model, and its simulation.
