...
This resource provides an interactive app file (MATLAB virtual laboratory) which demonstrates the cruise control behaviour of a simplified car model, as appropriate to a first course in control, and subject to normal disturbances such as wind and road slope. The app includes PI control parameters. More detailed descriptions and help are in the partner livescript file cruisecontrol_manual.mlx.
