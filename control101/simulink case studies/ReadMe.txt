AppName: Livescripts for a first course in control
...
This resource provides an introduction to the use of simulink for modelling and simulation system behaviour through a number of case studies. The main resource is a number of simulink files representing the case studies and some livescript files with background and coding examples for using the simulink models.
