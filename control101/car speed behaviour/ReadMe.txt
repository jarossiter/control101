...
This resource provides an interactive app file (MATLAB virtual laboratory) which demonstrates the speed behaviour of a simplified car model, as appropriate to a first course in control, and subject to normal disturbances such as wind and road slope. More detailed descriptions and help are in the partner livescript file carmodel_and_behaviour_manual.mlx.
