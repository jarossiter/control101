...
This resource provides an interactive app file (MATLAB virtual laboratory) which demonstrates the temperature behaviour of a simplified housemodel or thermal system, as appropriate to a first course in control, and subject to normal disturbances such as changes in external temperature. More detailed descriptions and help are in the partner livescript file housetemperature_and_behaviour_manual.mlx.
