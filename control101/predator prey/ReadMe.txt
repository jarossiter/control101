...
This resource provides an interactive app file (MATLAB virtual laboratory) which demonstrates  the behaviour of a simplified predator-prey model. The file raises users awareness of the complexities in the behaviour of many real systems which are non-linear and also implicitly contain feedback between the different states. More detailed descriptions and help are in the partner livescript file predator_prey_model_manual.mlx.
