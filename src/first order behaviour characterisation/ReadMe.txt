AppName: First order behaviour characterisation
...
This resource provides an interactive app file (MATLAB virtual laboratory) which characterises the behaviour of a simplified first order model using time constant and gain and allows users to explore the definition of these. More detailed descriptions and help are in the partner livescript file firstordermodels_response_characterisation_manual.mlx.
