AppName: DC servo and position control
...
This resource provides an interactive app file (MATLAB virtual laboratory) which demonstrates the behaviour of a DC servo model driving a load through a gear system. The app allows the user to design and test control laws for both position and velocity targets. The app includes PI control parameters. More detailed descriptions and help are in the partner livescript file dcservo_and_position_control_manual.mlx.
